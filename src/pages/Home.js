  ...
  return (
    <>
      <div className="home">
          ...
          <div className="about-us-group" data-scroll-to="groupContainer1">
            ...
            <div className="welcome-to-dream-container">
              <p className="our-team-of">
                ...
                all with exceptional skill and creativity.
              </p>
              <p className="our-team-of">
                ...
                unique style that beautifully enhances your precious moments.
                Not only do we serve Madurai and Chennai, but our services
                extend throughout Tamil Nadu, and we're available for
                assignments all over South India.
              </p>
              <p className="our-team-of">
                At Dream Big Studios, we believe in the magic of preserving
                every special moment with perfection. Founded by the dynamic duo
                of Vasanth and Deva, we're driven by our love for visual
                storytelling and creating timeless memories. If you're looking
                to capture your cherished moments with a touch of creativity and
                expertise, look no further than Dream Big Studio – where your
                dreams become stunning realities.
              </p>
            </div>
          </div>
        ...
        <div className="group-parent1">
          <div className="our-service-parent" data-scroll-to="groupContainer">
            ...
            <div className="at-dream-big2">
              ...
              Our team of skilled professionals is dedicated to ensuring that
              your memories are captured with precision and creativity. Here are
        ...
        <AddressSection />
        <Property1S1
          property1S1Position="absolute"
          property1S1Top="5024px"
          property1S1Left="64px"
        />
